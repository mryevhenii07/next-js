      ...
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          ...
          <p className="py-2 text-gray-600">
            ...
            computers. In 2019 I started working with HTML and CSS to make some minor edits on a
            small business website that I was operating. What I thought was just a few small edits
          ...
          <p className="py-2 text-gray-600">
            ...
            spending my time building projects with React JS, Firebase, and learning new
            technologies.
          </p>
